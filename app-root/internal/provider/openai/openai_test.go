...
import (
	...
	openaibackend "github.com/ai4mgreenly/ikigai-cli/internal/provider/openai"
)
...
// TestR_6MCB_UMJV_ExportedSymbolsPresent verifies the package exposes
// the constructor and configuration methods used by cmd/ and driver/.
func TestR_6MCB_UMJV_ExportedSymbolsPresent(t *testing.T) {
